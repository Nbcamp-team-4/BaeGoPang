package com._team._project.domain.cart.api.response;
...
public class GetCartResponse {
    ...
    public static class CartItemResponse {
        ...
        public static CartItemResponse from(com._team._project.domain.cart.entity.CartItem item) {
    ...
    public static class CartItemOptionResponse {
        ...
        public static CartItemOptionResponse from(com._team._project.domain.cart.entity.CartItemOption opt) {
